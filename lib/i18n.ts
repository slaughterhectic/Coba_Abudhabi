...
const en = {
  ...
  happening: {
    ...
    items: [
      ...
      { img: "act-kidsart-v5", cap: "Kids art club", tag: "For children" },
      { img: "act-makeup-v5", cap: "Image masterclasses", tag: "For adults" },
      ...
      { img: "act-adultart-v5", cap: "Adult art classes", tag: "For adults" },
      { img: "act-mumtoddler-v5", cap: "Mother & toddler mornings", tag: "For families" },
      ...
      { img: "act-etiquette-v5", cap: "Kids & teens etiquette", tag: "For children" },
  ...
  room: {
    ...
    shots: [
      ...
      { img: "act-etiquette-v5", cap: "Etiquette classes" },
      { img: "act-parents", cap: "Parents talking" },
      { img: "act-mumtoddler-v5", cap: "Mum & toddler mornings" },
  ...
  happens: {
    ...
    cards: [
      ...
      },
      {
        ...
        media: { type: "image" as const, src: "act-adultart-v5" },
      },
      {
        idx: "Three",
        title: "Connect",
...
const ru: typeof en = {
  ...
  happening: {
    ...
    items: [
      ...
      { img: "act-kidsart-v5", cap: "Детский арт-клуб", tag: "Детям" },
      { img: "act-makeup-v5", cap: "Мастер-классы по имиджу", tag: "Взрослым" },
      ...
      { img: "act-adultart-v5", cap: "Живопись для взрослых", tag: "Взрослым" },
      { img: "act-mumtoddler-v5", cap: "Утро для мам и малышей", tag: "Семьям" },
      ...
      { img: "act-etiquette-v5", cap: "Этикет для детей и подростков", tag: "Детям" },
  ...
  room: {
    ...
    shots: [
      ...
      { img: "act-etiquette-v5", cap: "Уроки этикета" },
      { img: "act-parents", cap: "Родители общаются" },
      { img: "act-mumtoddler-v5", cap: "Утро для мам и малышей" },
