...
const en = {
  ...
  heroSlides: [
    { img: "hero-kidsart", tag: "Art clubs for children" },
    { img: "hero-birthday", tag: "Kids birthday parties" },
    { img: "hero-family", tag: "Mother & toddler mornings" },
    { img: "hero-ladies", tag: "Workshops for ladies" },
    { img: "hero-networking", tag: "Networking & private events" },
  ],
  ...
  happening: {
    ...
    items: [
      ...
      { img: "act-kidsart-v2", cap: "Kids art club", tag: "For children" },
      { img: "act-makeup-v2", cap: "Image masterclasses", tag: "For adults" },
      { img: "act-lego-v2", cap: "LEGO workshops", tag: "For children" },
      ...
      { img: "act-adultart-v2", cap: "Adult art classes", tag: "For adults" },
      { img: "act-mumtoddler-v2", cap: "Mother & toddler mornings", tag: "For families" },
      ...
      { img: "act-etiquette-v2", cap: "Kids & teens etiquette", tag: "For children" },
  ...
  room: {
    ...
    shots: [
      ...
      { img: "act-lego-v2", cap: "LEGO builders" },
      { img: "act-coffee", cap: "Coffee conversations" },
      { img: "act-etiquette-v2", cap: "Etiquette classes" },
      { img: "act-parents", cap: "Parents talking" },
      { img: "act-mumtoddler-v2", cap: "Mum & toddler mornings" },
  ...
  happens: {
    ...
    cards: [
      ...
      },
      {
        ...
        media: { type: "image" as const, src: "act-adultart-v2" },
      },
      {
        idx: "Three",
        title: "Connect",
...
const ru: typeof en = {
  ...
  heroSlides: [
    { img: "hero-kidsart", tag: "Арт-клубы для детей" },
    { img: "hero-birthday", tag: "Детские дни рождения" },
    { img: "hero-family", tag: "Утро для мам и малышей" },
    { img: "hero-ladies", tag: "Мастер-классы для леди" },
    { img: "hero-networking", tag: "Нетворкинг и частные события" },
  ],
  ...
  happening: {
    ...
    items: [
      ...
      { img: "act-kidsart-v2", cap: "Детский арт-клуб", tag: "Детям" },
      { img: "act-makeup-v2", cap: "Мастер-классы по имиджу", tag: "Взрослым" },
      { img: "act-lego-v2", cap: "LEGO-мастерские", tag: "Детям" },
      ...
      { img: "act-adultart-v2", cap: "Живопись для взрослых", tag: "Взрослым" },
      { img: "act-mumtoddler-v2", cap: "Утро для мам и малышей", tag: "Семьям" },
      ...
      { img: "act-etiquette-v2", cap: "Этикет для детей и подростков", tag: "Детям" },
  ...
  room: {
    ...
    shots: [
      ...
      { img: "act-lego-v2", cap: "Строители LEGO" },
      { img: "act-coffee", cap: "Разговоры за кофе" },
      { img: "act-etiquette-v2", cap: "Уроки этикета" },
      { img: "act-parents", cap: "Родители общаются" },
      { img: "act-mumtoddler-v2", cap: "Утро для мам и малышей" },
