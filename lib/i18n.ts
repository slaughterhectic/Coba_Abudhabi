...
const en = {
  ...
  heroSlides: [
    { img: "hero-kidsart-v2", tag: "Art clubs for children" },
    { img: "hero-birthday-v2", tag: "Kids birthday parties" },
    { img: "hero-family-v2", tag: "Mother & toddler mornings" },
    { img: "hero-ladies-v2", tag: "Workshops for ladies" },
    { img: "hero-networking-v2", tag: "Networking & private events" },
  ],
  ...
  happening: {
    ...
    items: [
      ...
      { img: "act-kidsart-v3", cap: "Kids art club", tag: "For children" },
      { img: "act-makeup-v3", cap: "Image masterclasses", tag: "For adults" },
      ...
      { img: "act-adultart-v3", cap: "Adult art classes", tag: "For adults" },
      { img: "act-mumtoddler-v3", cap: "Mother & toddler mornings", tag: "For families" },
      ...
      { img: "act-etiquette-v3", cap: "Kids & teens etiquette", tag: "For children" },
  ...
  room: {
    ...
    shots: [
      ...
      { img: "act-etiquette-v3", cap: "Etiquette classes" },
      { img: "act-parents", cap: "Parents talking" },
      { img: "act-mumtoddler-v3", cap: "Mum & toddler mornings" },
  ...
  happens: {
    ...
    cards: [
      ...
      },
      {
        ...
        media: { type: "image" as const, src: "act-adultart-v3" },
      },
      {
        idx: "Three",
        title: "Connect",
...
const ru: typeof en = {
  ...
  heroSlides: [
    { img: "hero-kidsart-v2", tag: "Арт-клубы для детей" },
    { img: "hero-birthday-v2", tag: "Детские дни рождения" },
    { img: "hero-family-v2", tag: "Утро для мам и малышей" },
    { img: "hero-ladies-v2", tag: "Мастер-классы для леди" },
    { img: "hero-networking-v2", tag: "Нетворкинг и частные события" },
  ],
  ...
  happening: {
    ...
    items: [
      ...
      { img: "act-kidsart-v3", cap: "Детский арт-клуб", tag: "Детям" },
      { img: "act-makeup-v3", cap: "Мастер-классы по имиджу", tag: "Взрослым" },
      ...
      { img: "act-adultart-v3", cap: "Живопись для взрослых", tag: "Взрослым" },
      { img: "act-mumtoddler-v3", cap: "Утро для мам и малышей", tag: "Семьям" },
      ...
      { img: "act-etiquette-v3", cap: "Этикет для детей и подростков", tag: "Детям" },
  ...
  room: {
    ...
    shots: [
      ...
      { img: "act-etiquette-v3", cap: "Уроки этикета" },
      { img: "act-parents", cap: "Родители общаются" },
      { img: "act-mumtoddler-v3", cap: "Утро для мам и малышей" },
